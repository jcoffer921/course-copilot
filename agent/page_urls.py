...
urlpatterns = [
    ...
    path("faculty/", page_views.faculty_dashboard_page, name="faculty-dashboard"),
    path("faculty/import/", page_views.faculty_import_page, name="faculty-import"),
    path("faculty/cora/", page_views.faculty_planner_page, name="faculty-planner"),
